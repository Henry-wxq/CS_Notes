...
################################################################################
def test_contains_at_beginning() -> None:
    """Test <item> is in the beginning of the list.
    """
...
def test_contains_at_end() -> None:
    """Test <item> is in the end of the list.
    """
    lst = three_items(1, 2, 3)
    got = 3 in lst
    assert got == True
...
def test_contains_at_middle() -> None:
    """Test <item> is in the middle of the list.
    """
    lst = three_items(1, 2, 3)
    got = 2 in lst
    assert got == True
...
def test_contains_list_empty() -> None:
    """Test <item> for an empty linked list.
    """
    lst = LinkedList()
    got = 5 in lst
    assert got == False
