...
def test_max_length_int() -> None:
    """Test max_length on an integer number.
    """
    assert max_length(1729) == 0
...
def test_max_length_only_integers() -> None:
    """Test max_length on a nested list contain only integers
