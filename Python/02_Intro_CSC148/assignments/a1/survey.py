...
class NumericQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return f"{self.text} (enter an integer between " \
...
class YesNoQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return f"{self.id}: {self.text} (Yes or No)"
...
class CheckboxQuestion(MultipleChoiceQuestion):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        options_str = ', '.join(self._options)
        return f"{self.text} ({options_str})"
    ...
    def validate_answer(self, answer: Answer) -> bool:
        ...
        """
        selected_options = answer.content
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        Preconditions:
            - <answer1> and <answer2> are both valid answers to this question
        """
        unique_strings = list(set(answer1.content + answer2.content))
        num_unique_strings = len(unique_strings)

        common_strings = []
        for string in unique_strings:
            if string in answer1.content and string in answer2.content:
                common_strings.append(string)
        num_common_strings = len(common_strings)

        if num_unique_strings == 0:
            similarity = 1.0
        else:
            similarity = num_common_strings / num_unique_strings
...
class Answer:
    ...
    #         return False
    #     return self is other and id(self) == id(other)
...
class Survey:
    ...
    def __init__(self, questions: list[Question]) -> None:
        ...
        for question in questions:
            ...
            self._criteria[question.id] = default_criterion
            self._weights[question.id] = default_weight
    ...
    def __str__(self) -> str:
        ...
        for question_id in self._questions:
            survey_str += str(self._questions[question_id]) + "\n"
        return survey_str
    ...
    def score_students(self, students: list[Student]) -> float:
        ...
        for question in self.get_questions():
            try:
                ...
                quality_score = criterion.score_answers(question, answers)
                total_quality_score += quality_score * weight
                count += 1
            except InvalidAnswerError:
                return 0.0

        return total_quality_score / count
