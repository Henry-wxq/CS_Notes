...
class TestGym(unittest.TestCase):
    ...
    def test_register_same_time(self):
        self.gym.add_room("AC", 10)
        self.gym.add_room("BC", 10)
        self.gym.add_workout_class(WorkoutClass('Boot Camp', ['Cardio 1']))
        self.gym.add_instructor(self.instructor1)
        self.instructor1.add_certificate("Cardio 1")
        self.gym.add_workout_class(WorkoutClass('Boot Camp 2', ['Cardio 1']))
        self.gym.add_instructor(self.instructor2)
        self.instructor2.add_certificate("Cardio 1")
        time_point = datetime(2019, 9, 9, 12, 0)
        self.assertTrue(self.gym.schedule_workout_class(time_point, "AC", "Boot Camp", 1))
        self.assertTrue(self.gym.schedule_workout_class(time_point, "BC", "Boot Camp", 2))
        self.gym._schedule[time_point]["BC"][2].append("PP1")
        self.gym._schedule[time_point]["BC"][2].append("PP2")
        self.gym._schedule[time_point]["BC"][2].append("PP3")
        self.assertTrue(self.gym.register(time_point, "Gary", "Boot Camp"))
        self.assertTrue(len(self.gym._schedule[time_point]["BC"][2]) == 4)
        self.assertFalse(self.gym.register(time_point, "Gary", "Boot Camp"))
    ...
    def test_offer_multiple_instructor_same_name(self):
        ...
        time_point = datetime(2019, 9, 9, 12, 0)
        self.gym.schedule_workout_class(time_point, "AC", "Intro to Com Sci", 1)
        exp = [{'Date': 'Monday, 2019-09-09', 'Time': '12:00', 'Class': 'Intro to Com Sci', 'Room': 'AC', 'Registered': 0, 'Available': 10, 'Instructor': 'Diane (1)'}]
        act = self.gym.offerings_at(time_point)
        self.assertEqual(exp, self.gym.offerings_at(time_point), self.msg(exp, act))

    def test_offer_multiple_instructor_same_name_2(self):
        self.gym.add_room("AC", 10)
        self.gym.add_room("BA", 10)
        self.gym.add_workout_class(self.workout1)
        self.gym.add_instructor(self.instructor1)
    ...
    def test_to_schedule_list_1(self):
        ...
        self.gym.schedule_workout_class(time_point2, "AC", "Intro to Com Sci", 1)
        self.gym.schedule_workout_class(time_point, "BA", "Intro to Com Sci", 2)
        exp = [{'Date': 'Friday, 2019-08-30', 'Time': '12:00', 'Class': 'Intro to Com Sci', 'Room': 'BA', 'Registered': 0, 'Available': 10, 'Instructor': 'David'},
               {'Date': 'Sunday, 2019-09-01', 'Time': '13:00', 'Class': 'Intro to Com Sci', 'Room': 'AC', 'Registered': 0, 'Available': 10, 'Instructor': 'Diane'}]
    ...
    def test_to_schedule_list_3(self):
        time_point = datetime(2019, 8, 30, 12, 0)
        time_point2 = datetime(2019, 9, 1, 13, 0)
        self.gym.add_room("AC", 10)
        self.gym.add_room("BA", 10)
        ...
        self.gym.add_instructor(self.instructor2)
        self.instructor2.add_certificate("Intro to Com Sci")
        self.gym.add_instructor(Instructor(3, "David"))
        self.gym.schedule_workout_class(time_point2, "AC",
                                        "Intro to Com Sci", 1)
        self.gym.schedule_workout_class(time_point, "BA",
                                        "Intro to Com Sci", 2)
        ...
        exp = [{'Date': 'Friday, 2019-08-30', 'Time': '12:00',
                'Class': 'Intro to Com Sci', 'Room': 'BA', 'Registered': 0,
                'Available': 10, 'Instructor': 'David (2)'},
               {'Date': 'Sunday, 2019-09-01', 'Time': '13:00',
                'Class': 'Intro to Com Sci', 'Room': 'AC',
                'Registered': 0, 'Available': 10, 'Instructor': 'Diane'},
               {'Date': 'Sunday, 2019-09-01', 'Time': '13:00',
                'Class': 'Intro to SE', 'Room': 'BA',
                'Registered': 0, 'Available': 10, 'Instructor': 'David (2)'},
               {'Date': 'Sunday, 2019-09-01', 'Time': '13:00',
                'Class': 'Intro to DB', 'Room': 'SS',
                'Registered': 0, 'Available': 10, 'Instructor': 'David (3)'}]
        act = self.gym.to_schedule_list()
        self.assertEqual(exp, act, act)

    def test_eq_different_type(self):
        self.assertNotEqual(self.gym, "You should check isinstance first.")

    def test_eq_different_type_2(self):
        class MockGym:
        ...
        mockGym = MockGym("gym")
        self.assertNotEqual(self.gym, mockGym)


    def test_eq_1(self):
        otherGym = Gym("gym")
        self.assertEqual(self.gym, otherGym)

    def test_eq_2(self):
        otherGym = Gym("gym")
        self._build_for_eq(self.gym)
        self._build_for_eq(otherGym)
        self.assertEqual(self.gym, otherGym)

    def _build_for_eq(self, gym):
        time_point = datetime(2019, 8, 30, 12, 0)
        time_point2 = datetime(2019, 9, 1, 13, 0)
        gym.add_room("AC", 10)
        gym.add_room("BA", 10)
        gym.add_room("SS", 10)
        gym.add_workout_class(self.workout1)
        gym.add_workout_class(self.workout2)
        gym.add_workout_class(WorkoutClass("Intro to DB", []))
        gym.add_instructor(self.instructor1)
        gym.add_instructor(self.instructor2)
        self.instructor2.add_certificate("Intro to Com Sci")
        gym.schedule_workout_class(time_point2, "AC",
                                        "Intro to Com Sci", 1)
        gym.schedule_workout_class(time_point, "BA",
                                        "Intro to Com Sci", 2)
        gym.schedule_workout_class(time_point2, "AC",
                                        "Intro to Com Sci",
                                        1)
        gym.schedule_workout_class(time_point2, "BA", "Intro to SE", 2)
